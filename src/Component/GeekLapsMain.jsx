        ...
        <Row className={` ${styles.MainRow}`}>
          ...
          >
            <Row className="d-flex justify-content-between mb-4">
              <Col className="col-3 col-lg-2 mt-1">
                <img
                  src={logo}
                  alt=""
                  className={` ${styles.mainLogo} w-100`}
                />
              </Col>
              ...
              <Col className="col-3 col-sm-2 col-lg-1 position-relative mt-2">
            ...
            <Row>
              <Col xs={12} className={` ${styles.NonificationCol} me-2 col-9 `}>
                {FilteredNotification().length === 0 && (
                  <Alert key="warning" className="ms-5" variant="warning">
